...
public class Query {
    ...
    public static final String GET_ASSIGNMENT_BY_SID = "SELECT a.assignment_id, a.reviewer_id, u.first_name, u.email, a.cid, a.sid FROM assignment a, users u WHERE a.reviewer_id = u.id AND a.valid = 'Y' AND a.sid = ?";
    public static final String GET_ASSIGNMENT_BY_UID = "SELECT a.assignment_id, a.reviewer_id, u.first_name, u.email, a.cid, a.sid FROM assignment a, users u WHERE a.reviewer_id = u.id AND a.valid = 'Y' AND a.cid = ? AND a.reviewer_id = ?";
